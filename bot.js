 ...
 **
رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=528293651294453760&permissions=0&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discord.gg/qYa3U3k
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', msg => {
  if (msg.content === '.') {
    msg.channel.send(' **__-Wèlçomè Ťø Legends__** ');
  }
});
